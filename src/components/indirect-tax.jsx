...
const indirect_tax = () => {
  return (
    <div className="container pt-5">
      <Helmet title="Indirect Tax" />
      <div className="row">
        <div className="col-12 text-center bsa my-5">INDIRECT TAX</div>
      </div>
      <div className="row">
      ...
      <div className="row my-5">
        <div className="col-md-6 my-5">
          <div className="title-bsa">INDIAN LEGISLATION AND RULES:</div>
          <br />
          <div className="content-l">
            <ul>
              <li>
                Chapter V of the Finance Act, 1994 (Service Tax Legislation)
              </li>
        ...
        <div className="col-md-5 my-5">
          ...
          <div className="content-l">
            <ul>
              <li>
                Advising on operations/transactions and tax
                benefits/exemptions/set offs available.
              </li>
              ...
              <li>
                Opportunities, devising the most tax efficient models and
                comprehensive range of compliance services.
              </li>
              <li>
                Providing on-call advisory services on specific Indirect Tax
                queries.
              </li>
            </ul>
          </div>
